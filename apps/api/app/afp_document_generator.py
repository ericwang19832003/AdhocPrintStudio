...
SF_PGD = bytes([0xD3, 0xA6, 0xAF])  # Page Descriptor
...
SF_IID = bytes([0xD3, 0xA6, 0x7B])  # Image Input Descriptor

# Include Page Segment
SF_IPS = bytes([0xD3, 0xAF, 0x5F])  # Include Page Segment

# Active Environment Group
SF_BAG = bytes([0xD3, 0xA8, 0xC9])  # Begin Active Environment Group
SF_EAG = bytes([0xD3, 0xA9, 0xC9])  # End Active Environment Group
...
SF_BNG = bytes([0xD3, 0xA8, 0xAD])  # Begin Named Page Group
SF_ENG = bytes([0xD3, 0xA9, 0xAD])  # End Named Page Group
