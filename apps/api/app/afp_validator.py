...
SF_TYPES = {
    ...
    (0xD3, 0xA6, 0xAF): ("PGD", "Page Descriptor"),
    (0xD3, 0xA6, 0xC4): ("PGD", "Page Descriptor (legacy nonstandard id)"),
    ...
    # Spec-correct MO:DCA ids (used by the Exstream 22.3 output format)
    (0xD3, 0xA8, 0xAD): ("BNG", "Begin Named Page Group"),
    (0xD3, 0xA9, 0xAD): ("ENG", "End Named Page Group"),
    (0xD3, 0xA8, 0xC9): ("BAG", "Begin Active Environment Group"),
    (0xD3, 0xA9, 0xC9): ("EAG", "End Active Environment Group"),
    (0xD3, 0xA8, 0xCE): ("BRS", "Begin Resource"),
    (0xD3, 0xA9, 0xCE): ("ERS", "End Resource"),
    # Legacy nonstandard ids kept so older BlueCrest-format files still parse
    (0xD3, 0xA8, 0xDF): ("BNG", "Begin Named Page Group (legacy nonstandard id)"),
    (0xD3, 0xA9, 0xDF): ("ENG", "End Named Page Group (legacy nonstandard id)"),
